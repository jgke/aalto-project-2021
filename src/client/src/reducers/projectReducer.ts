...
export const projectReducer = (
    ...
    switch (action.type) {
        ...
        case 'PROJECT_UPDATE': {
            return state.map((p) =>
                p.id !== action.data.id ? p : action.data
            );
        }
        default:
            return state;
...
export const projectInit = (): ThunkAction<
    Promise<void>,
    ProjectState,
    void,
    ProjectInitAction
...
export const projectAdd = (
    project: IProject
): ThunkAction<Promise<void>, ProjectState, void, ProjectAddAction> => {
    return async (
...
export const projectUpdate = (
    project: IProject
): ThunkAction<Promise<void>, ProjectState, void, ProjectUpdateAction> => {
    return async (
        dispatch: ThunkDispatch<ProjectState, void, ProjectUpdateAction>
    ) => {
