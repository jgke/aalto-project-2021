...
beforeEach(async () => {
    ...
    ids = []
    let r = await db.query("INSERT INTO node (description, status, priority, x, y) VALUES ($1, $2, $3, $4, $5) RETURNING id", [n1.description, n1.priority, n1.status, n1.x, n1.y])
...
describe("DELETE request", () => {
    test("should delete a single edge", async () => {
        ...
        await api
            .delete(`${baseUrl}/${res.body[0].source_id}/${res.body[0].target_id}`)
            .expect(200)
